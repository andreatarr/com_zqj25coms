...
class Zqj25comsControllerZqj25com extends JControllerForm
{
	...
	public function subscribe ($key = null, $urlVar = 'sub_id')
	{
		...
		if (!JFactory::getUser()->authorise('core.edit', 'com_zqj25coms.category.' . $this->category->id)) {
		...
		$this->setRedirect(JRoute::_('index.php?option=com_zqj25coms&amp;view=form&amp;layout=thankyou'));
		...
		$this->setRedirect(JRoute::_('index.php?option=com_zqj25coms&amp;view=form&amp;layout=thankyou&amp;sub_id='.$id)) ;
		return true;
	}
